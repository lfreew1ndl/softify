...
<link rel="stylesheet" media="screen,projection" type="text/css" href="css/adminPage.css" />
      ...
      <ul class="articles box event-list">
       <!-- begin eventsItem -->
        ...
        <li>
            ...
            <img alt="Independence Day" src="https://farm4.staticflickr.com/3100/2693171833_3545fb852c_q.jpg" />
            <div class="info">
              <h2 class="title">Thanks giving Day</h2>
              <p class="desc">United States Holiday</p>
              <a class="detail" href="#">Detail</a>
            </div>
        </li>
...
>>>>>>> 2cddc8aebdf4d02194cd956075bacc32ffb2758a:src/main/webapp/index.jsp
